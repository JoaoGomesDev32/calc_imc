...
export default function Dataimc() {
  ...
  useEffect(() => {
    ...
    if (router.query.weight && router.query.height && router.query.imc) {
      setWeight(router.query.weight as string);
      setHeight(router.query.height as string);
      setImc(router.query.imc as string);
    }
  }, [router.query]);
  ...
  const getCategoryColor = (category: string): string => {
    switch (category) {
      case "Abaixo do Peso": return "text-blue-600 bg-blue-50";
      case "Peso Normal": return "text-green-600 bg-green-50";
      case "Sobrepeso": return "text-yellow-600 bg-yellow-50";
      case "Obesidade Grau I": return "text-orange-600 bg-orange-50";
      case "Obesidade Grau II": return "text-red-600 bg-red-50";
      case "Obesidade Grau III": return "text-purple-600 bg-purple-50";
  ...
  const averageIMC = entries.length > 0 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 animate-fade-in">
            <div className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-xl p-6 border border-white/20">
              ...
              <form onSubmit={(e) => { e.preventDefault(); saveEntry(); }} className="space-y-4">
                <Campform
                  label="Nome"
                  state={name}
                  funcState={setName}
          ...
          <div className="lg:col-span-2 animate-slide-in">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
              ...
              <div className="bg-white/95 backdrop-blur-sm rounded-xl shadow-lg p-4 border border-white/20">
                <div className="text-2xl font-bold text-green-600">{averageIMC.toFixed(1)}</div>
                ...
                <table className="w-full">
                  <thead className="bg-gradient-to-r from-indigo-500 to-purple-600 text-white">
                    <tr>
                      ...
                      <th className="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider">Peso</th>
                      <th className="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider">Altura</th>
                      <th className="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider">IMC</th>
              ...
              {filteredEntries.length === 0 && (
                <div className="text-center py-12">
                  ...
                  <p className="mt-1 text-sm text-gray-500">
                    {searchTerm ? 'Tente ajustar os termos de busca.' : 'Comece adicionando seu primeiro registro.'}
                  </p>
                </div>
              )}
            </div>
